...
## Real Photo Available (Needs Loretta Review)
- ✅ **Book file:** `08 Real Testimony Visuals – Needs Review/CH02 James Covering/James_CH02_Insert.jpg` — cropped tighter + placard name blurred; **James unaltered**. (Original kept as reference only.)
- **Caption:** "James — a covering, a reminder that every girl needs someone safe, steady, and honorable."
- **Plan:** symbolic artwork = chapter opener; **James's real photo = sacred testimony insert** inside the chapter + optional 2–3 sec video overlay.
- **Privacy:** crop/blur the small background placard if it shows a name; keep James honorable and dignified.
