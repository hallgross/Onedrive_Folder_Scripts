...
|-------|--------------------------|
| **Photo type to use** | Photo of you alone, worshiping, praying, or standing strong |
| **Where to place it** | Inside chapter or video overlay |
| **Use type** | Inside book / Video overlay |
| **Privacy check** | Clear (sensitive chapter — lean symbolic) |
| **Status** | Needs Loretta Review |

## Per-photo tag (copy for each photo you add)
- **Filename:**
- **Suggested chapter:** CH06
- **What it represents:**
