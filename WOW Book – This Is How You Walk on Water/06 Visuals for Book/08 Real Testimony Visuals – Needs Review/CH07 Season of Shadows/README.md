...
|-------|--------------------------|
| **Photo type to use** | Home photo, keys, symbolic bills with all details hidden, dog collar, quiet room |
| **Where to place it** | Use as memory inserts only; blur addresses/account info |
| **Use type** | Inside book (memory insert) |
| **Privacy check** | Blur (addresses / account info hidden) |
| **Status** | Needs Loretta Review |

## Per-photo tag (copy for each photo you add)
- **Filename:**
- **Suggested chapter:** CH07
- **What it represents:**
