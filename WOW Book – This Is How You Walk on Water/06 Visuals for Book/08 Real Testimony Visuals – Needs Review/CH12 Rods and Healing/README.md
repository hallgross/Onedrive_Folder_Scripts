...
|-------|--------------------------|
| **Photo type to use** | X-ray / hardware image only if you are comfortable, or photo of you standing in strength |
| **Where to place it** | Use carefully; crop names/dates/medical numbers |
| **Use type** | Inside book |
| **Privacy check** | Crop (names / dates / medical numbers) |
| **Status** | Needs Loretta Review |

## Per-photo tag (copy for each photo you add)
- **Filename:**
- **Suggested chapter:** CH12
- **What it represents:**
