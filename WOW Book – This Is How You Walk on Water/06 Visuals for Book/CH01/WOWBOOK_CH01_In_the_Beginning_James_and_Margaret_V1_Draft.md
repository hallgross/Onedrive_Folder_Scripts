...
**Status:** Symbolic artwork (chapter opener)

## Loretta's Visual Direction (CH01)
Keep the newborn / golden light / family roots direction. The image should feel like a **sacred beginning, not sadness**. This is a **symbolic cinematic artwork chapter** — no childhood photo exists; the artwork itself is the visual (subject to Loretta's approval).

## Book Visual Prompt (placeholder direction — aligns with Loretta's note)
